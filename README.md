# Proyecto7
Proyecto del módulo 7

# Explorador de Anuncios de Vehículos (USA)
...
- **Gráfico de dispersión**: Analiza la correlación entre el kilometraje y el precio de venta para identificar patrones de depreciación.
- **Interfaz dinámica**: Uso de casillas de verificación para renderizar gráficos bajo demanda, optimizando la experiencia del usuario.